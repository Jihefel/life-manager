...
function Dashboard(props) {
  ...
  useEffect(() => {
    ...
    switch (true) {
      ...
      case heureActuelle >= 10 && (heureActuelle < 12 || (heureActuelle === 12 && minuteActuelle <= 30)):
        ...
        break;
      // Déjeuner
      case ((heureActuelle >= 12 && minuteActuelle <= 30) || heureActuelle >= 12) &&
        (heureActuelle < 15 || (heureActuelle === 15 && minuteActuelle < 30)):
      ...
      case heureActuelle >= 23 || heureActuelle < 7:
        if (heureActuelle >= 0 && heureActuelle < 7) {
          periodesDesRepas = Object.keys(menu[JOURS[jourActuel === "lundi" ? 6 : JOURS.indexOf(jourActuel) - 1]].v1);
  ...
  useEffect(() => {
    if (periodeRepas) {
      if (heureActuelle >= 0 && heureActuelle < 7) {
        setRepasActuel(
          Object.entries(menu[JOURS[jourActuel === "lundi" ? 6 : JOURS.indexOf(jourActuel) - 1]].v1).find((repas) => repas[0] === periodeRepas)
        );
      } else {
